...
*Figure 1 — SCI carries mutation-effect signal (C1). Composite panels:
`figure_assembly/calibration_crops/Fig1_PanelA.png` +
`figure_assembly/calibration_crops/Fig1_PanelB.png`*
...
Composite panels: `figure_assembly/calibration_crops/Fig2_PanelA.png` +
`figure_assembly/calibration_crops/Fig2_PanelB.png` +
`figure_assembly/calibration_crops/Fig2_PanelC.png`*
...
Composite panels: `figure_assembly/calibration_crops/Fig3_PanelA.png` +
`figure_assembly/calibration_crops/Fig3_PanelB.png` +
`figure_assembly/calibration_crops/Fig3_PanelC.png`*
...
Composite panels: `figure_assembly/calibration_crops/Fig4_PanelA.png` +
`figure_assembly/calibration_crops/Fig4_PanelB.png`*
...
Composite panels: `figure_assembly/calibration_crops/Fig5_PanelA.png` +
`figure_assembly/calibration_crops/Fig5_PanelB.png` +
`figure_assembly/calibration_crops/Fig5_PanelC.png`*
